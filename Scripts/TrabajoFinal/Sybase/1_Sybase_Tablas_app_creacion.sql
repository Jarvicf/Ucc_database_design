...
/* Created on:     11/11/2023 11:13:54 a. m.                    */
/*==============================================================*/
...
(
   ...
   CONSTRAINT PK_DOCUMENTO_IDENTIDAD PRIMARY KEY CLUSTERED (ID_DOCUMENTO)
);
...
CREATE TABLE EQUIPO 
(
   ID_EQUIPO            NUMERIC(5)                     NOT NULL DEFAULT AUTOINCREMENT,
...
(
   ...
   CONSTRAINT PK_GOLES PRIMARY KEY CLUSTERED (ID_REGISTRO_GOLES)
);
...
(
   ...
   CONSTRAINT PK_MINUTOS PRIMARY KEY CLUSTERED (ID_REGISTRO_MINUTOS)
);
...
(
   ...
   CONSTRAINT PK_PARTIDOS PRIMARY KEY CLUSTERED (ID_PARTIDO)
);
...
(
   ...
   CONSTRAINT PK_PASES PRIMARY KEY CLUSTERED (ID_REGISTRO_PASES)
);
...
(
   ...
   CONSTRAINT PK_TARJETAS PRIMARY KEY CLUSTERED (ID_REGISTRO_TARJETAS)
);
...
(
   ID_TECNICO           NUMERIC(10)                    NOT NULL,
   NUMERO_DOCUMENTO     NUMERIC(10)                    NOT NULL,
   CONSTRAINT PK_TECNICO PRIMARY KEY CLUSTERED (ID_TECNICO)
);
...
(
   ...
   CONSTRAINT PK_TIPO_PIERNA_HABIL PRIMARY KEY CLUSTERED (ID_PIERNA_HABIL)
);
...
(
   ...
   CONSTRAINT PK_TIPO_POSICIONES_JUGADOR PRIMARY KEY CLUSTERED (ID_TIPO_POSICION_JUGADOR)
);
...
(
   ...
   CONSTRAINT PK_TIPO_POSICIONES_TERRENO PRIMARY KEY CLUSTERED (ID_TIPO_POSICION_TERRENO)
);
...
(
   ID_TORNEO            NUMERIC(2)                     NOT NULL DEFAULT AUTOINCREMENT,
   NOMBRE_TORNEO        VARCHAR(50)                    NULL,
   RUTA_IMAGEN          VARCHAR(100)                   NULL,
   CONSTRAINT PK_TORNEOS PRIMARY KEY CLUSTERED (ID_TORNEO)
);
...
(
   ...
   CONSTRAINT PK_USUARIO PRIMARY KEY CLUSTERED (NUMERO_DOCUMENTO)
);
