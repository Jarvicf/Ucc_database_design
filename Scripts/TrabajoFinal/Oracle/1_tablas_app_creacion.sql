...
/* Created on:     08/11/2023 08:16:38 p. m.                    */
/*==============================================================*/
...
CREATE TABLE TIPO_POSICIONES_JUGADOR  (
   ...
   DESC_TIPO_POSICION_JUGADOR VARCHAR(30),
...
CREATE TABLE TIPO_POSICIONES_TERRENO  (
   ID_TIPO_POSICION_TERRENO NUMERIC(2, 0)                   NOT NULL,
   DESC_TIPO_POSICION_TERRENO VARCHAR(30),
...
ALTER TABLE EQUIPO
   ADD CONSTRAINT FK_EQUIPO_REF_PARTIDOS FOREIGN KEY (ID_PARTIDO)
